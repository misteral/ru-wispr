...
gh release download "${TAG}" --pattern "*.bottle.tar.gz" --dir "${DL_DIR}" --repo human37/ru-wisper
...
ruby -e '
  ...
  lines = ["  bottle do"]
  lines << "    root_url \"https://github.com/human37/ru-wisper/releases/download/#{tag}\""
