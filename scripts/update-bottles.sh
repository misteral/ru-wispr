...
gh release download "${TAG}" --pattern "*.bottle.tar.gz" --dir "${DL_DIR}" --repo misteral/dikto
...
ruby -e '
  ...
  lines = ["  bottle do"]
  lines << "    root_url \"https://github.com/misteral/dikto/releases/download/#{tag}\""
