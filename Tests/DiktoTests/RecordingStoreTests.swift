...
final class RecordingStoreTests: XCTestCase {
    ...
    override func setUp() {
        ...
        testDir = FileManager.default.temporaryDirectory.appendingPathComponent("dikto-test-\(UUID().uuidString)")
    ...
    func testTempRecordingURL() {
        ...
        XCTAssertEqual(url.lastPathComponent, "dikto-recording.wav")
    }
