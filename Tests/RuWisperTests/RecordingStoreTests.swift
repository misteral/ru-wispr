...
final class RecordingStoreTests: XCTestCase {
    ...
    override func setUp() {
        ...
        testDir = FileManager.default.temporaryDirectory.appendingPathComponent("ru-wisper-test-\(UUID().uuidString)")
    ...
    func testTempRecordingURL() {
        ...
        XCTAssertEqual(url.lastPathComponent, "ru-wisper-recording.wav")
    }
